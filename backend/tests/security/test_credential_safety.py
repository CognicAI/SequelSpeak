...
def mock_auth():
    ...
    These tests focus on credential safety and input validation, not authentication.
    ...
    with patch('utils.auth.authenticate_request') as mock_auth_request:
        ...
        mock_request_state.to_auth.return_value = mock_auth_obj
