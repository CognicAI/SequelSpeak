...
class TestErrorClassifier:
    ...
    def test_auth_failed_no_pg_hba(self):
    ...
    def test_auth_failed_permission_denied(self):
    ...
    def test_database_not_found_alternate(self):
    ...
    def test_ssl_error_certificate_verify(self):
    ...
    def test_ssl_error_self_signed(self):
    ...
    def test_ssl_error_expired(self):
    ...
    def test_timeout_expired(self):
        ...
        error_code, message = ErrorClassifier.classify_error(error_msg, 15)
    ...
    def test_timeout_timed_out(self):
        ...
        error_code, message = ErrorClassifier.classify_error(error_msg, 20)
    ...
    def test_could_not_connect_to_server(self):
    ...
    def test_could_not_translate_hostname(self):
    ...
    def test_regex_pattern_matching(self):
        ...
        error_code1, _ = ErrorClassifier.classify_error(error_msg1, 10)
        ...
        error_code2, _ = ErrorClassifier.classify_error(error_msg2, 10)
